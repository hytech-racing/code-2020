...
static void loadLookupTable() {
  ...
  CAN_MSG_DEFINITION[0xAB] = pair<string, vector<definition>> ("ID_MC_FAULT_CODES", {
    definition(7, 1, { "Motor Over-speed Fault", "Over-current Fault", "Over-voltage Fault", "Inverter Over-temperature Fault", "Accelerator Input Shorted Fault", "Accelerator Input Open Fault", "Direction Command Fault", "Inverter Response Time-out Fault" }),
    definition(6, 1, { "Reserved", "Reserved", "Reserved", "Motor Over-temperature Fault", "CAN Command Message Lost Fault", "Under-voltage Fault", "Hardware Over-current Fault", "Hardware Gate/Desaturation Fault" }),
    definition(5, 1, { "Gate Drive Board 2 Over-temperature Fault7", "Gate Drive Board 1 Over-temperature Fault", "PCB Over-temperature Fault7", "Module C Over-temperature Fault7", "Module B Over-temperature Fault7", "Module A Over-temperature Fault1", "Brake Input Open Fault", "Brake Input Shorted Fault" }),
    definition(4, 1, { "Inverter Discharge Active (warning)", "Resolver Not Connected", "Reserved", "Reserved", "Reserved", "Reserved", "Current Sensor Fault", "Gate Drive Board 3 Over-temperature Fault7" }),
    definition(3, 1, { "Module Temperature High", "Module Temperature Low", "Current Sensor High", "Current Sensor Low", "Accelerator Open", "Accelerator Shorted", "HW Over-current Fault", "Hardware Gate/Desaturation Fault" }),
    definition(2, 1, { "12V Sense Voltage High", "12V Sense Voltage Low", "5V Sense Voltage High", "5V Sense Voltage Low", "Gate Drive PCB Temperature High", "Gate Drive PCB Temperature Low", "Control PCB Temperature High", "Control PCB Temperature Low" }),
    definition(1, 1, { "Pre-charge Voltage Failure", "Pre-charge Timeout", "DC Bus Voltage Low", "DC Bus Voltage High", "1.5V Sense Voltage High", "1.5V Sense Voltage Low", "2.5V Sense Voltage High", "2.5V Sense Voltage Low" }),
    definition(0, 1, { "Brake Open", "Brake Shorted", "Reserved", "Reserved", "Reserved", "EEPROM Update Required (warning)", "EEPROM Data Out of Range", "EEPROM Checksum Invalid" })
  });
