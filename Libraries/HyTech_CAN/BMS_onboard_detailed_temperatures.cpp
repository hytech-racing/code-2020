...
BMS_onboard_detailed_temperatures::BMS_onboard_detailed_temperatures() : Abstract_CAN_Container() {};
BMS_onboard_detailed_temperatures::BMS_onboard_detailed_temperatures(uint8_t buf []) : Abstract_CAN_Container(buf) {};

BMS_onboard_detailed_temperatures::BMS_onboard_detailed_temperatures(uint8_t ic_id, int16_t temperature_0, int16_t temperature_1) : Abstract_CAN_Container() {
    set_ic_id(ic_id);
...
uint8_t BMS_onboard_detailed_temperatures::getIndex() {
    return get_ic_id();
}

void BMS_onboard_detailed_temperatures::setIndex(uint8_t index) {
    set_ic_id(index);
}